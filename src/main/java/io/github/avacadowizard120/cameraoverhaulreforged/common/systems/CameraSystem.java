package io.github.avacadowizard120.cameraoverhaulreforged.common.systems;

import io.github.avacadowizard120.cameraoverhaulreforged.CameraOverhaulReforged;
...
import io.github.avacadowizard120.cameraoverhaulreforged.core.utils.MathUtils;
import io.github.avacadowizard120.cameraoverhaulreforged.core.utils.Vec2fUtils;
...
public final class CameraSystem implements CameraUpdateCallback, ModifyCameraTransformCallback
{
    ...
    public CameraSystem()
    {
        ...
        CameraOverhaulReforged.LOGGER.info("CameraOverhaul - CameraSystem is ready.");
    }
    ...
    public void OnCameraUpdate(Entity focusedEntity, Camera camera, Transform cameraTransform, float deltaTime)
    {
        ...
        ConfigData config = CameraOverhaulReforged.instance.config;
        ...
        if (isFlying)
        {
            if (!CameraOverhaulReforged.isBarrelRollLoaded)
            {
        ...
        if (CameraOverhaulReforged.isBarrelRollLoaded && strafingRollFactorToUse == config.getStrafingRollFactorWhenFlying)
        {
            CameraOverhaulReforged.LOGGER.info("Barrel Roll is loaded");
        } else {
            //X
