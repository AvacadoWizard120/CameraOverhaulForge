package io.github.avacadowizard120.cameraoverhaulreforged.core.configuration;
...
public final class Configuration
{
    ...
    public static <T extends BaseConfigData> T LoadConfig(Class<T> tClass, String configName, int configVersion) {
        ...
        try {
            ...
            CameraOverhaulReforged.LOGGER.error("Error when initializing config", e);
        }
    ...
    public static <T extends BaseConfigData> void SaveConfig(T configData, String configName, int configVersion) {
        ...
        try (BufferedWriter writer = Files.newBufferedWriter(configFile)) {
            ...
            CameraOverhaulReforged.LOGGER.error("Couldn't save config file", e);
        }
    }
}